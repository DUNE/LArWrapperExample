...
def main():
    ...
    parser.add_argument('--defName', default="protodune-sp_runset_5141_raw_v0", type=str, help='samweb dataset definition name')
    ...
    parser.add_argument('-c', default="protoDUNE_SP_keepup_decoder_reco_stage1.fcl", type=str, help='name of fcl file')
    parser.add_argument('--user', default = os.getenv("USER"),type=str, help='user name')
    parser.add_argument('-n', type=int, default=2, help='number of events total to process')
