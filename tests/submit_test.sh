...
python -m submit_dd_jobs --debug=True --dataset=schellma:rawPhysics_5141_5143 --query_limit=3 --query_skip=20\
 -c  protoDUNE_SP_keepup_decoder_reco_stage1.fcl  --njobs=2 -n 2 --load_limit=2 --appFamily=LArSoft --appName=reco --appVersion=${DUNESW_VERSION} #--blacklist="BNL"
